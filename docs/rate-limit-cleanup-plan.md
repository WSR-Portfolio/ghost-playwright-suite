...
**Status:** In progress — Steps 1–4 and 6 complete; Steps 5 and 7 pending the admin-2FA empirical check and CI verification (both require `DB_PASSWORD` in local `.env` and as GitHub Actions secrets).  
